    ...
    display_on_page.map do |job|
      unless job.nil?
        ...
        if job.is_open?
          ...
          delete = link_to I18n.translate(:delete), "jobs/delete/#{job.id}", data: { confirm: I18n.translate("jobs.really_delete") }, remote: true, :class => 'delete_job'
        else
          edit = ""
          add_to_current = ""
          delete = ""
