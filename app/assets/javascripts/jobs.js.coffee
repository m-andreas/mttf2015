...
# Auftragseingabemaske
  ...
  high_distance = () ->
    (parseInt($("#job_mileage_delivery").val()) || 0 ) - (parseInt($("#job_mileage_collection").val()) || 0) > 1500 ||
    (parseInt($("#job_mileage_delivery").val()) || 0 ) - (parseInt($("#job_mileage_collection").val()) || 0) < 0
